...
if($_POST['ques_name'])
{
	...
	pt_register('POST','q1_user');
	pt_register('POST','q2_user');
	pt_register('POST','q3_user');
	pt_register('POST','q4_user');
	pt_register('POST','q5_user');
	pt_register('POST','q6_user');
	pt_register('POST','q6_user_a');
	pt_register('POST','q7_user');
	...
	else
	{
		...
		{
			$querydb = "SELECT COUNT(*) FROM `question_user`";
			...
			mysql_query("INSERT INTO `question_user` ( `Sno` , `contact_name` , `ques_profession` , `ques_organization` , `ques_designation` , `ques_email` , `ques_phone` , `add_for_future` , `date_of_submit` , `q1` , `q2` , `q3` , `q4` , `q5` , `q6` , `q6_a` , `q7`) VALUES ('".$sno."' , '".$ques_name."' , '".$ques_profession."' , '".$ques_organization."' , '".$ques_designation."' , '".$ques_email."' , '".$ques_phone."' , '".$add_for_future."' , '".$date."' , '".$q1."' , '".$q2."' , '".$q3."' , '".$q4."' , '".$q5."' , '".$q6."' , '".$q6_a."' , '".$q7."' )");
...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#94A707">
          <tr>
            <td width="195" height="432" align="center" valign="top" bgcolor="#CCDF55"><table width="100%" cellpadding="0" cellspacing="0">
              <tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF" style="padding-left:30px; padding-right:30px;"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td height="360" align="left" valign="top" class="main-text">We appreciate your effort in helping us improve this software. Your responses shall help us in providing better features in RoboAnalyzer in future.<br />
<br />
                  Thanks
  <br />
